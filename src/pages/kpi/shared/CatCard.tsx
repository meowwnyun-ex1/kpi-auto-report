...
import { useSystemStandards, useSystemValidation } from '@/hooks/useSystemStandards';
      ...
      <Card
        ...
        <div className="p-4 pb-3">
            ...
            <div className="flex-1">
              ...
              <div className="flex items-center gap-1">
                {[...Array(5)].map((_, i) => (
                  <svg
                    key={i}
                    className={`w-3 h-3 ${i < Math.round(achievement / 20) ? 'text-yellow-400 fill-current' : 'text-gray-300'}`}
                    viewBox="0 0 20 20">
          ...
          <div className="bg-gray-50 rounded-lg px-1 py-3 mb-3 mx-1">
            ...
            {!window.location.pathname.includes('result') && (
              <div className="text-xs text-gray-400 text-center mt-2">Targets</div>
            )}
          </div>
