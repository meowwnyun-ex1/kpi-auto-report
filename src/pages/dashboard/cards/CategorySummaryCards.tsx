        ...
        <Card
          ...
          <CardContent className="p-4">
            <div className="flex items-center justify-between">
              <div>
                <p className="text-xs font-medium" style={{ color: catColor }}>
                  Total Measurements
                </p>
            ...
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-2xl font-bold text-gray-900">
                  {formatNumber(catStats.passedCount, 0)}
                </p>
                <p className="text-xs text-green-500">
                  {formatPercent(catStats.passRate)} pass rate
                </p>
              </div>
          ...
          <CardContent className="p-4">
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-2xl font-bold text-gray-900">
                  {formatNumber(catStats.pendingCount, 0)}
                </p>
                <p className="text-xs text-amber-500">
                  {formatPercent(catStats.achievementRate)} filled
                </p>
              </div>
          ...
          <CardContent className="p-4">
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-2xl font-bold text-gray-900">
                  {formatNumber(catStats.failedCount, 0)}
                </p>
                <p className="text-xs text-red-500">
                  {formatPercent(catStats.resultRate)} result rate
                </p>
              </div>
          ...
          <div className="flex items-center justify-between mb-3">
            ...
            <div className="flex items-center gap-2">
              ...
              <span className="text-2xl font-bold" style={{ color: catColor }}>
                {formatPercent(catStats.resultRate)}
              </span>
            </div>
          </div>
          <div className="grid grid-cols-3 gap-4 mb-3 text-sm">
            <div className="text-center">
              ...
              <div className="font-mono font-bold text-gray-800">
                {formatNumber(catStats.totalTarget, 2)}
              </div>
            </div>
            <div className="text-center">
              <div className="text-gray-500">Result</div>
              <div className="font-mono font-bold" style={{ color: catColor }}>
                {formatNumber(catStats.totalResult, 2)}
              </div>
            </div>
            <div className="text-center">
              <div className="text-gray-500">Gap</div>
              <div
                className={`font-mono font-bold ${catStats.totalResult >= catStats.totalTarget ? 'text-green-600' : 'text-red-600'}`}>
                {formatNumber(catStats.totalResult - catStats.totalTarget, 2)}
              </div>
            </div>
          </div>
          <Progress
