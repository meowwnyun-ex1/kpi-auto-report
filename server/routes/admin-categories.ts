      ...
      const mockCategories = [
        {
          ...
          name: 'Safety',
          key: 'safety',
          description: 'Safety measurements',
          color: '#ef4444',
          icon: 'Shield',
          sort_order: 1,
          is_active: true,
        ...
        },
        {
          ...
          name: 'Delivery',
          key: 'delivery',
          description: 'Delivery measurements',
          color: '#10b981',
          icon: 'Truck',
          sort_order: 3,
          is_active: true,
        ...
        },
        {
          ...
          name: 'Environment',
          key: 'environment',
          description: 'Environment measurements',
          color: '#06b6d4',
          icon: 'Leaf',
          sort_order: 6,
          is_active: true,
        ...
        },
        {
          ...
          name: 'Compliance',
          key: 'compliance',
          description: 'Compliance measurements',
          color: '#6366f1',
          icon: 'FileText',
          sort_order: 7,
          is_active: true,
        ...
        },
        {
          ...
          name: 'Attractive',
          key: 'attractive',
          description: 'Attractive measurements',
          color: '#ec4899',
          icon: 'Heart',
          sort_order: 8,
          is_active: true,
